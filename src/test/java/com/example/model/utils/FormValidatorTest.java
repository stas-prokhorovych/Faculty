...
class FormValidatorTest {
    ...
    void testCheckLoginForm() {
        ...
        assertTrue(result3.containsValue("Login is not valid(4-16 symbols a-z and - _)"));
        assertTrue(result3.containsValue("Password is not valid(more than 2 characters)"));
        ...
        assertTrue(result4.containsValue("Password is not valid(more than 2 characters)"));
    }
    ...
    void testCheckSignupForm() {
        ...
        assertTrue(result3.containsValue("Email is not valid(example: oleg@gmail.com)"));
        assertTrue(result3.containsValue("First Name is not valid(example: Victor)"));
        assertTrue(result3.containsValue("Last Name is not valid(example: Pelosi)"));
        assertTrue(result3.containsValue("Phone is not valid(example: +380976504426)"));
    }
