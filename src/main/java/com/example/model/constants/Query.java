...
public final class Query {
    ...
    public static final String FIND_NEW_USER = "SELECT * FROM user WHERE role='Student' AND id NOT IN(SELECT DISTINCT id_user FROM course_student)";
    ...
    public static final String START_COURSE = "UPDATE course SET start_date=?, course_status='In progress' WHERE course.id = ?";
    public static final String FIND_NO_TEACHER_COURSES = "SELECT * FROM course WHERE course_status = 'Closed, no teacher assigned yet'";
    public static final String FIND_ALL_OPEN_COURSES_BY_TEACHER_ID = "SELECT * FROM course WHERE id_lecturer=? AND course_status = 'Opened for registration'";
